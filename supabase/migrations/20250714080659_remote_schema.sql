...
begin
  if new.raw_user_meta_data->>'avatar_url' is null or new.raw_user_meta_data->>'avatar_url' = '' then
   new.raw_user_meta_data = jsonb_set(new.raw_user_meta_data, '{avatar_url}', '"https://cdn.pixabay.com/photo/2023/02/18/11/00/icon-7797704_1280.png"' ::jsonb);
  end if;
...
create policy "Enable Admin Only Delete"
on "public"."category"
as permissive
for delete
to authenticated
...
create policy "Enable Admin Only Insert"
on "public"."category"
as permissive
for insert
to authenticated
...
create policy "Enable Admin Only Update"
on "public"."category"
as permissive
for update
to authenticated
...
create policy "Allow all Operation for Users"
on "public"."order"
as permissive
for all
to authenticated
